...
export const itemsHomeStyles = {
  ...
  addButton: "bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white cursor-pointer px-4 py-2 rounded-full flex items-center transition-shadow shadow-md hover:shadow-lg",
...
export const navbarStyles = {
  ...
  mobileLogoText: "text-xl font-bold text-transparent bg-clip-text bg-linear-to-r from-green-300 to-emerald-300",
