...
export const bannerStyles = {
  backgroundGradient: "absolute inset-0 bg-linear-to-r from-mint-100 to-seafoam-100 z-0",
...
export const cartStyles = {
  ...
  continueShopping: "inline-flex cursor-pointer items-center text-emerald-200 hover:text-white mb-8 text-sm sm:text-base",
  ...
  emptyCartText: "text-emerald-200 mb-6 max-w-md mx-auto text-sm sm:text-base",
  emptyCartButton: "inline-block cursor-pointer bg-emerald-400 hover:bg-emerald-300 text-black font-bold py-2.5 px-6 sm:py-3 sm:px-8 rounded-full transition-all duration-300 hover:scale-[1.03] text-sm sm:text-base",
  headerContainer: "text-center mb-10",
  headerTitle: "text-3xl sm:text-4xl font-bold font-cursive text-emerald-100 mt-8 sm:mt-12",
  clearCartButton: "text-emerald-200 mt-2 cursor-pointer hover:text-red-400 flex justify-center items-center text-sm sm:text-base",
  ...
  cartItemPrice: "text-emerald-200 mb-4 text-sm sm:text-base",
  cartItemQuantityContainer: "flex items-center space-x-4 mb-4",
  cartItemQuantityButton: "p-2 cursor-pointer text-emerald-200 hover:text-white",
  cartItemQuantity: "text-emerald-50 w-6 sm:w-8 text-center cursor-pointer",
  cartItemRemoveButton: "flex items-center cursor-pointer text-emerald-200 hover:text-red-400 text-sm sm:text-base",
  ...
  orderSummaryLabel: "text-emerald-200",
...
const contactStyles = {
  ...
  divider: "w-32 h-1 bg-linear-to-r from-emerald-400 to-green-300 rounded-full mt-4",
...
export const footerStyles = {
  ...
  topBorder: "hidden md:block absolute top-0 left-0 w-full h-2 bg-linear-to-r from-emerald-500 to-emerald-400 z-20",
  ...
  brandText: "text-emerald-100 mb-6 leading-relaxed text-sm sm:text-base",
  ...
  newsletterInput: "w-full sm:flex-1 bg-emerald-800 border-2 border-emerald-600 rounded-t-xl sm:rounded-l-xl sm:rounded-tr-none px-4 py-2 text-white placeholder-emerald-200 focus:outline-none focus:border-emerald-400 mb-2 sm:mb-0",
  newsletterButton: "w-full sm:w-auto bg-linear-to-r from-emerald-500 to-emerald-700 hover:from-emerald-400 hover:to-emerald-600 px-4 py-2 rounded-b-xl sm:rounded-r-xl sm:rounded-bl-none flex items-center justify-center transition-transform transform hover:-translate-y-1",
  privacyText: "text-emerald-200 text-xs sm:text-sm",
...
export const itemsPageStyles = {
  ...
  dividerLine: "w-24 h-1 bg-linear-to-r from-emerald-400 to-teal-400 rounded-full",
  searchContainer: "mb-10 max-w-2xl mx-auto",
  searchForm: "relative",
  searchInput: "w-full py-3 px-4 pr-12 rounded-2xl bg-emerald-800 text-emerald-100 border border-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-inner placeholder-emerald-200",
  ...
  categoryDivider: "ml-4 flex-1 h-px bg-linear-to-r from-emerald-700 to-transparent",
  ...
  clearSearchButton: "bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white cursor-pointer px-6 py-3 rounded-full font-medium shadow-md hover:shadow-lg transition-colors",
  ...
  productDescription: "mt-2 text-emerald-100 text-sm h-12 overflow-hidden",
  priceContainer: "mt-4 flex justify-between items-center",
  currentPrice: "text-emerald-50 font-bold text-xl",
  oldPrice: "text-emerald-400 line-through text-sm",
  ...
  export const checkoutStyles = {
    ...
    submitButton: "bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white",
  ...
  emptyButton: "inline-flex items-center bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium py-2 px-6 rounded-full transition-colors shadow-lg shadow-emerald-900/30",
  ...
  submitButton: "bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-lg shadow-emerald-900/30",
 ...
 // Styles object matching the requested theme
  export const ordersPageStyles = {
    ...
    closeButton: "px-6 py-2 bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white rounded-full transition-colors shadow-lg shadow-emerald-900/30 font-medium"
  };
...
export const itemsHomeStyles = {
  ...
  productImage: "max-h-full object-contain transition-transform duration-300",
  productContent: "p-5",
  ...
  currentPrice: "text-emerald-700 font-bold text-xl",
  oldPrice: "text-gray-600 text-sm line-through",
  addButton: "bg-linear-to-r from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white cursor-pointer px-4 py-2 rounded-full flex items-center transition-shadow shadow-md hover:shadow-lg",
  ...
  noProductsText: "text-emerald-700 font-medium text-xl mb-4",
  clearSearchButton: "bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white cursor-pointer px-6 py-3 rounded-full font-medium shadow-md hover:shadow-lg transition-colors",
  viewAllButton: "bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white cursor-pointer px-8 py-4 rounded-full font-bold shadow-lg hover:shadow-xl transition-transform duration-300 inline-flex items-center text-lg",
...
export const navbarStyles = {
  ...
  unscrolledNav: "bg-linear-to-r from-black/80 via-slate-900/80 to-black/80 backdrop-blur-lg h-20",
  borderGradient: "absolute bottom-0 left-0 right-0 h-[1px] bg-linear-to-r from-transparent via-emerald-500/50 to-transparent",
  ...
  logoText: "text-2xl font-bold text-transparent bg-clip-text bg-linear-to-r from-green-300 to-emerald-300 tracking-tight",
  ...
  activeNavItem: "text-white underline decoration-green-400 decoration-2 underline-offset-4",
  inactiveNavItem: "text-slate-200 hover:text-white transition-colors",
  navIcon: "mr-2 transition-transform",
  activeNavIcon: "scale-125",
  inactiveNavIcon: "group-hover:scale-110",
  navIndicator: "absolute -bottom-1 h-0.5 bg-linear-to-r from-green-400 to-emerald-400 rounded-full transition-all duration-500",
  ...
  cartIcon: "h-5 w-5 text-slate-100 hover:text-green-200 transition-transform",
  cartBadge: "absolute -top-1 -right-1 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-black bg-green-400 rounded-full transform transition-transform duration-300 hover:scale-110",
  ...
  mobileLogoText: "text-xl font-bold text-transparent bg-clip-text bg-linear-to-r from-green-200 to-emerald-200",
  closeButton: "p-2 rounded-full transition-colors hover:bg-slate-800",
  mobileItemsContainer: "p-4 space-y-2",
  mobileItem: "flex items-center bg-linear-to-r from-black/80 via-slate-900/80 to-black/80 p-4 rounded-xl transition-all duration-300 hover:bg-slate-800/60 text-slate-200 hover:text-green-300",
  ...
  loginButton: "col-span-2 flex items-center justify-center p-3 bg-linear-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 group",
